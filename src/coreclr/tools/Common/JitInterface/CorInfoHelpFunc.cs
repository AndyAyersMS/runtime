...
namespace Internal.JitInterface
{
    ...
    public enum CorInfoHelpFunc
    {
        ...
        CORINFO_HELP_DELEGATEPROFILE_WITHCALLER32, // 32-bit caller-sensitive delegate-target profile
        CORINFO_HELP_DELEGATEPROFILE_WITHCALLER64, // 64-bit caller-sensitive delegate-target profile
        CORINFO_HELP_VTABLEPROFILE_WITHCALLER32,   // 32-bit caller-sensitive vtable-target profile
        CORINFO_HELP_VTABLEPROFILE_WITHCALLER64,   // 64-bit caller-sensitive vtable-target profile
