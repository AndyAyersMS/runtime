...
def setup_args(args):
    ...
    coreclr_args.verify(args,
                        ...
                        modify_arg=lambda core_root_directory: os.path.abspath(release_core_root_directory))
...
def main(main_args):
    ...
    if coreclr_args.collection_name == "benchmarks" or coreclr_args.collection_name == "realworld":
      ...
      jitname = determine_jit_name(coreclr_args.host_os, coreclr_args.target_os, coreclr_args.arch, coreclr_args.target_arch)
