...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER(CORINFO_HELP_NEW_MDARR,            NULL,                     METHOD__ARRAY__CTOR)
    DYNAMICJITHELPER(CORINFO_HELP_NEW_MDARR_RARE,       NULL,                     METHOD__ARRAY__CTOR)
    ...
    JITHELPER(CORINFO_HELP_CLASSPROFILE_WITHCALLER32, JIT_ClassProfileWithCaller32, METHOD__NIL)
    JITHELPER(CORINFO_HELP_CLASSPROFILE_WITHCALLER64, JIT_ClassProfileWithCaller64, METHOD__NIL)
    JITHELPER(CORINFO_HELP_DELEGATEPROFILE_WITHCALLER32, JIT_DelegateProfileWithCaller32, METHOD__NIL)
    JITHELPER(CORINFO_HELP_DELEGATEPROFILE_WITHCALLER64, JIT_DelegateProfileWithCaller64, METHOD__NIL)
    JITHELPER(CORINFO_HELP_VTABLEPROFILE_WITHCALLER32, JIT_VTableProfileWithCaller32, METHOD__NIL)
    JITHELPER(CORINFO_HELP_VTABLEPROFILE_WITHCALLER64, JIT_VTableProfileWithCaller64, METHOD__NIL)
#else
    ...
    JITHELPER(CORINFO_HELP_CLASSPROFILE_WITHCALLER32, NULL, METHOD__NIL)
    JITHELPER(CORINFO_HELP_CLASSPROFILE_WITHCALLER64, NULL, METHOD__NIL)
    JITHELPER(CORINFO_HELP_DELEGATEPROFILE_WITHCALLER32, NULL, METHOD__NIL)
    JITHELPER(CORINFO_HELP_DELEGATEPROFILE_WITHCALLER64, NULL, METHOD__NIL)
    JITHELPER(CORINFO_HELP_VTABLEPROFILE_WITHCALLER32, NULL, METHOD__NIL)
    JITHELPER(CORINFO_HELP_VTABLEPROFILE_WITHCALLER64, NULL, METHOD__NIL)
#endif
