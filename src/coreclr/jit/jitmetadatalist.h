...
JITMETADATAMETRIC(LoopsUnswitched,                       int,              0)
JITMETADATAMETRIC(LoopsRejectedForUnswitching,           int,              0)
JITMETADATAMETRIC(LoopsRejectedForUnswitchingDegenerate, int,              0)
JITMETADATAMETRIC(LoopsRejectedForUnswitchingCannotDup,  int,              0)
JITMETADATAMETRIC(LoopsRejectedForUnswitchingTooLarge,   int,              0)
JITMETADATAMETRIC(LoopsRejectedForUnswitchingTooCostly,  int,              0)
JITMETADATAMETRIC(LoopsRejectedForUnswitchingSkew,       int,              0)
JITMETADATAMETRIC(LoopsConsideredForUnswitching,         int,              0)
JITMETADATAMETRIC(LoopsCondCouldBeArrLen,                int,              0)
JITMETADATAMETRIC(LoopsCondCouldBeArrLenNonNull,         int,              0)
JITMETADATAMETRIC(LoopsCondHasArrLenAny,                 int,              0)
JITMETADATAMETRIC(LoopsCondCouldBeInvariantLoad,         int,              0)
JITMETADATAMETRIC(LoopsCondCouldBeInvariantLoadNonFault, int,              0)
JITMETADATAMETRIC(LoopsCondHasInvariantLoadAny,          int,              0)
JITMETADATAMETRIC(LoopsWithMultipleUnswitchCandidates,   int,              0)
JITMETADATAMETRIC(LoopsBetterUnswitchCandidateExists,    int,              0)
JITMETADATAMETRIC(LoopsUnswitchPickedDifferent,          int,              0)
JITMETADATAMETRIC(LoopsMultiCandAdjacent,                int,              0)
JITMETADATAMETRIC(LoopsMultiCandAdjacentAnd,             int,              0)
JITMETADATAMETRIC(LoopsMultiCandAdjacentOr,              int,              0)
JITMETADATAMETRIC(LoopsMultiCandAdjacentPairs,           int,              0)
JITMETADATAMETRIC(LoopsUnswitchSharedBody0,              int,              0)
JITMETADATAMETRIC(LoopsUnswitchSharedBody1to3,           int,              0)
JITMETADATAMETRIC(LoopsUnswitchSharedBody4to10,          int,              0)
JITMETADATAMETRIC(LoopsUnswitchSharedBody11to30,         int,              0)
JITMETADATAMETRIC(LoopsUnswitchSharedBody31to100,        int,              0)
JITMETADATAMETRIC(LoopsUnswitchSharedBodyOver100,        int,              0)
JITMETADATAMETRIC(LoopsUnswitchLoopSize0to50,            int,              0)
JITMETADATAMETRIC(LoopsUnswitchLoopSize51to100,          int,              0)
JITMETADATAMETRIC(LoopsUnswitchLoopSize101to200,         int,              0)
JITMETADATAMETRIC(LoopsUnswitchLoopSize201to400,         int,              0)
JITMETADATAMETRIC(LoopsUnswitchLoopSizeOver400,          int,              0)
JITMETADATAMETRIC(LoopsUnswitchCondSkewBalanced,         int,              0)
JITMETADATAMETRIC(LoopsUnswitchCondSkewMild,             int,              0)
JITMETADATAMETRIC(LoopsUnswitchCondSkewModerate,         int,              0)
JITMETADATAMETRIC(LoopsUnswitchCondSkewExtreme,          int,              0)
JITMETADATAMETRIC(LoopsUnswitchCondFromProfile,          int,              0)
